...
export const Footer = () => {
    ...
    return (
        <>
            <Grid container sx={{
                backgroundColor: selectedUI === 'Sahib' ? 'primary.light' : 'secondary.dark', height: 'auto', display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: 4, flexDirection: 'column', zIndex: 4, position: 'relative'
            }}>
                <Box sx={{ display: 'flex', width: 'fit-content' }}>
                    <Box
                        sx={{
                            width: responsive ? '37px' : '80px',
                            height: responsive ? '37px' : '80px',
                            ...
                            '&::after': {
                                ...
                                alignItems: 'center',
                                justifyContent: 'left',
                                width: responsive ? '31px' : '70px',
                                height: responsive ? '31px' : '70px',
                        ...
                        sahibUIPalette.map((item: { color: string }) => (
                            <Box key={item.color}>
                                <Box sx={{
                                    ...
                                    '&::after': {
                                        content: '""',
                                        width: responsive ? '31px' : '70px', // Tamaño del círculo interno
                                        height: responsive ? '31px' : '70px',
                ...
                <Box>
                    <Typography sx={{ color: selectedUI === 'Sahib' ? 'primary.600' : 'secondary.100', textAlign: 'center', padding: '3vh 0', fontWeight: 'bold' }}>
