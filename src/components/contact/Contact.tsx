                ...
                <div className="flex flex-col gap-10 max-w-5xl md:max-w-5xl lg:max-w-6xl xl:max-w-6xl mx-auto justify-items-start px-8 md:px-10 lg:px-10 xl:px-0">
                    <div className="flex flex-col gap-6">
                        ...
                        <a href="mailto:rojeru.san1983@gmail.com" target="_blank" className="mx-auto rounded-full" aria-label="Get in Touch">
                            <button aria-label="Get in Touch" className="bg-transparent hover:bg-primary-600/20 border-b border-primary-400 text-primary-100 font-bold font-body py-3 px-6 rounded-full transition-colors duration-300 mx-auto cursor-pointer flex items-center gap-2">
                                {t("button")}
