        ...
        <div className="grid grid-cols-2 xxs:grid-cols-1 md:grid-cols-2 gap-6">
            {projectsInfo.map((item, index) => (
                ...
                <div key={item.title} className="transition-transform duration-300">
                    ...
                    <div className="group rounded-b-xl border border-neutral-800 border-t-0 bg-neutral-900/20 p-6 flex flex-col gap-4 hover:border-primary-500/70 transition-colors duration-400">
