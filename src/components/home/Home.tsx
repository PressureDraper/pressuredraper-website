        ...
        <section id="home" className="relative z-0 min-h-[calc(100vh-4rem)] w-full pt-16">
            ...
            <div className="relative z-10 min-h-[calc(100vh-4rem)] flex flex-col justify-center max-w-6xl mx-auto gap-6 md:gap-8 px-8 md:px-10 lg:px-10 xl:px-0 py-10 xxs:py-0 xsl:py-10 xs:py-10 sm:py-10 md:py-10 lg:py-0 xl:py-0">
                ...
                <div className="flex flex-row gap-8 mt-5">
                    <a href="https://github.com/PressureDraper" target="_blank" aria-label="GitHub">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
                    ...
                    <a href="https://www.linkedin.com/in/pressuredraper" target="_blank" aria-label="LinkedIn">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke={'var(--color-neutral-400)'}
                    ...
                    <a href="mailto:rojeru.san1983@gmail.com" target="_blank" aria-label="Email">
                        <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke={'var(--color-neutral-400)'}
