        ...
        <>
            ...
            <div className="relative z-10 flex flex-col h-full justify-center max-w-6xl mx-auto gap-6 md:gap-8 px-8 md:px-0">
                ...
                <p className="text-neutral-400 text-lg md:text-xl max-w-2xl font-body">
                    Software Engineer with +4 years of experience specialized in full-stack development — building a seamless blend of performance, security and aesthetics.
                </p>
                ...
                <div className="flex flex-row gap-8 mt-5">
                    <a href="https://github.com/PressureDraper" target='_blank'>
                        <svg viewBox="0 0 24 24" fill="none" stroke={"var(--color-neutral-400)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='hover:cursor-pointer hover:stroke-neutral-200 transition-colors duration-300 w-5 h-5 md:w-5.5 md:5.5'>
                            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/in/pressuredraper" target='_blank'>
                        <svg viewBox="0 0 24 24" fill="none" stroke={"var(--color-neutral-400)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='hover:cursor-pointer hover:stroke-neutral-200 transition-colors duration-300 w-5 h-5 md:w-5.5 md:h-5.5'>
