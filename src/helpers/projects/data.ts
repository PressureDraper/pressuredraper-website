export const projectsInfo: { img: string, title: string, date: string, desc: string }[] = [
    {
        img: '/pressuredraper-website/projects/signsModule/cover.png',
    ...
    {
        img: '/pressuredraper-website/projects/personalWebsite/cover.png',
        title: 'Personal Website',
        date: 'Jan 2025 — Present',
        desc: 'Personal project developed as a portfolio to display all my professional path as a software engineer as well as a music producer as a hobby.'
    },
    {
        img: '/pressuredraper-website/projects/hresourcesSystem/cover.png',
        title: 'Human Resources System',
        date: 'Apr 2024 — Present',
        desc: "System application developed as a microservice inside the Administrative Clinical Integral System platform as a need of human resources department for displaying employee's attendances, incidences, permissions, vacations and holidays with a sub-module created for every functionality."
    },
    {
        img: '/pressuredraper-website/projects/medicalCongressv2/cover.png',
    ...
    {
        img: '/pressuredraper-website/projects/medicalCongressv1/cover.png',
    ...
    {
        img: '/pressuredraper-website/projects/medicalEvaluation/cover.png',
